...
class AlarmAddPage extends StatefulWidget {
  ...
  AlarmAddPage({super.key, AlarmData? alarmData})
    : alarmData =
          alarmData ??
          AlarmData(
            id: alarmDataList.length,
            index: 0,
            time: DateTime.now(),
            repeatDay: [false, false, false, false, false, false, false],
            on: false,
            ledBrightness: 0,
            ledBrightnessDration: 0,
            insertedDate: 0,
            alarmSoundUri: '',
            alarmSoundVolume: 0,
          );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('새 알람', style: TextStyle(fontSize: 18)),
        actions: [
          TextButton(
            onPressed: () {
              // 완료 눌렀을 때 원본 업데이트
                  ...
                  child: SizedBox(
                    ...
                    child: CupertinoDatePicker(
                      ...
                      onDateTimeChanged: (DateTime newTime) {
                        setState(() {
                          tempAlarmData = tempAlarmData.copyWith(time: newTime);
                        });
                      },
                      use24hFormat: false,
                    ...
                    OutlinedButton(
                      onPressed: () {
                        showCupertinoModalPopup(
                          ...
                          alarmController
                              .selectedSoundIndex
                              .value = alarmController.alarmSoundFiles.indexOf(
                            tempAlarmData.alarmSoundUri,
                          );
                        });
                      },
